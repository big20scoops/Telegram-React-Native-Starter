...
bool downcast_call(Object &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case chatEventSlowModeDelayChanged::ID:
      ...
      return true;
    case chatEventMessageTtlSettingChanged::ID:
      func(static_cast<chatEventMessageTtlSettingChanged &>(obj));
      return true;
    ...
    case chatEventInviteLinkDeleted::ID:
      ...
      return true;
    case chatEventVoiceChatCreated::ID:
      func(static_cast<chatEventVoiceChatCreated &>(obj));
      return true;
    case chatEventVoiceChatDiscarded::ID:
      func(static_cast<chatEventVoiceChatDiscarded &>(obj));
      return true;
    case chatEventVoiceChatParticipantIsMutedToggled::ID:
      func(static_cast<chatEventVoiceChatParticipantIsMutedToggled &>(obj));
      return true;
    case chatEventVoiceChatParticipantVolumeLevelChanged::ID:
      func(static_cast<chatEventVoiceChatParticipantVolumeLevelChanged &>(obj));
      return true;
    case chatEventVoiceChatMuteNewParticipantsToggled::ID:
      func(static_cast<chatEventVoiceChatMuteNewParticipantsToggled &>(obj));
      return true;
    ...
    case groupCallId::ID:
      ...
      return true;
    case groupCallJoinResponseWebrtc::ID:
      func(static_cast<groupCallJoinResponseWebrtc &>(obj));
      return true;
    case groupCallJoinResponseStream::ID:
      func(static_cast<groupCallJoinResponseStream &>(obj));
      return true;
    case groupCallJoinResponseCandidate::ID:
      func(static_cast<groupCallJoinResponseCandidate &>(obj));
      return true;
    case groupCallParticipant::ID:
      func(static_cast<groupCallParticipant &>(obj));
      return true;
    case groupCallPayload::ID:
      func(static_cast<groupCallPayload &>(obj));
      return true;
    case groupCallPayloadFingerprint::ID:
      func(static_cast<groupCallPayloadFingerprint &>(obj));
      return true;
    ...
    case messageCall::ID:
      ...
      return true;
    case messageVoiceChatScheduled::ID:
      func(static_cast<messageVoiceChatScheduled &>(obj));
      return true;
    case messageVoiceChatStarted::ID:
      func(static_cast<messageVoiceChatStarted &>(obj));
      return true;
    case messageVoiceChatEnded::ID:
      func(static_cast<messageVoiceChatEnded &>(obj));
      return true;
    case messageInviteVoiceChatParticipants::ID:
      func(static_cast<messageInviteVoiceChatParticipants &>(obj));
      return true;
    ...
    case paymentForm::ID:
      ...
      return true;
    case paymentFormTheme::ID:
      func(static_cast<paymentFormTheme &>(obj));
      return true;
    ...
    case suggestedActionCheckPhoneNumber::ID:
      ...
      return true;
    case suggestedActionSeeTicksHint::ID:
      func(static_cast<suggestedActionSeeTicksHint &>(obj));
      return true;
    ...
    case updateChatHasScheduledMessages::ID:
      ...
      return true;
    case updateChatVoiceChat::ID:
      func(static_cast<updateChatVoiceChat &>(obj));
      return true;
    ...
    case videoNote::ID:
      ...
      return true;
    case voiceChat::ID:
      func(static_cast<voiceChat &>(obj));
      return true;
    case voiceNote::ID:
...
bool downcast_call(Function &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case createTemporaryPassword::ID:
      ...
      return true;
    case createVoiceChat::ID:
      func(static_cast<createVoiceChat &>(obj));
      return true;
    ...
    case getUserProfilePhotos::ID:
      ...
      return true;
    case getVoiceChatAvailableParticipants::ID:
      func(static_cast<getVoiceChatAvailableParticipants &>(obj));
      return true;
    ...
    case setChatMemberStatus::ID:
      ...
      return true;
    case setChatMessageTtlSetting::ID:
      func(static_cast<setChatMessageTtlSetting &>(obj));
      return true;
    ...
    case setUsername::ID:
      ...
      return true;
    case setVoiceChatDefaultParticipant::ID:
      func(static_cast<setVoiceChatDefaultParticipant &>(obj));
      return true;
 ...
 */
template <class T>
bool downcast_call(GroupCallJoinResponse &obj, const T &func) {
  switch (obj.get_id()) {
    case groupCallJoinResponseWebrtc::ID:
      func(static_cast<groupCallJoinResponseWebrtc &>(obj));
      return true;
